...
export async function getServerSideProps(context) {
  ...
  console.log("JWT_SECRET loaded on server:", jwtSecret);
  // ------------------------------------
  ...
  try {
    ...
    console.error("Dashboard verification/fetch error:", error.message);
    return {
      redirect: {
        destination: '/superadmin/login',
        permanent: false,
...
// ... the rest of your SuperAdminDashboard component is the same
